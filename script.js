...
const state = dialog.querySelector("#status")
...
title.addEventListener("blur", (e) => checkField(e.target))
author.addEventListener("blur", (e) => checkField(e.target))
state.addEventListener("blur", (e) => checkField(e.target))
...
function checkField (element) {
    if (element.value === '') {
        ...
        element.setCustomValidity('This is required!')
    } else {
